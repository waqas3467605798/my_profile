    ...
    <h4 className="center-align blue-text grey lighten-4">Job Experience</h4>
                ...
                <div className='container'>
                        ...
                        <span className="card-title black-text"> <b>Key responsiblities </b> </span>
                                ...
                                <div className="card blue-grey lighten-4 experience"> Preparation of periodical/Monthly Financial Statements. </div>
                                ...
                                <div className="card blue-grey lighten-4 experience"> Checking and Monitoring bank reconciliation statements</div>
                                <div className="card blue-grey lighten-4 experience"> Maintains the Chart of Accounts and Trial Balance.</div>
                                <div className="card blue-grey lighten-4 experience"> Monitoring and follow up of Accounts Receivables and Accounts Payables</div>
                                ...
                                <div className="card blue-grey lighten-4 experience"> Dealing with banks for foreign remittances/payments and get foreign rates on daily basis.</div>
                                ...
                                <div className="card blue-grey lighten-4 experience"> Maintain/Reconcile the record of Rebate receivables/Sales tax refundable and report to the higher management.</div>
                                ...
                                <div className="card blue-grey lighten-4 experience"> Submission of W.H.Tax deducted from the payments from Parties. </div>
